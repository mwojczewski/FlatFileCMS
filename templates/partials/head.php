...
<?php if (is_string($icons['svg'] ?? null)): ?>
    <link rel="icon" href="<?= $context->escape($icons['svg']) ?>" type="image/svg+xml">
<?php endif; ?>

<?php if (is_string($icons['ico'] ?? null)): ?>
    <link rel="icon" href="<?= $context->escape($icons['ico']) ?>" sizes="any">
<?php endif; ?>
<?php if (is_string($icons['png32'] ?? null)): ?>
    <link rel="icon" href="<?= $context->escape($icons['png32']) ?>" type="image/png" sizes="32x32">
<?php endif; ?>
<?php if (is_string($icons['png16'] ?? null)): ?>
    <link rel="icon" href="<?= $context->escape($icons['png16']) ?>" type="image/png" sizes="16x16">
<?php endif; ?>
<?php if (is_string($icons['appleTouch'] ?? null)): ?>
    <link rel="
apple-touch-icon" href="<?= $context->escape($icons['appleTouch']) ?>" sizes="180x180">
<?php endif; ?>

<?php if (is_string($icons['appleTouchPrecomposed'] ?? null)): ?>
    <link rel="apple-touch-icon-precomposed" href="<?= $context->escape($icons['appleTouchPrecomposed']) ?>"
        sizes="180x180">
<?php endif; ?>
<?php if (is_string($icons['manifest'] ?? null)): ?>
    <link rel="manifest" href="<?= $context->escape($icons['manifest']) ?>">
    <?php endif; ?>
