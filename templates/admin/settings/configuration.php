...
<nav class="settings-submenu" aria-label="Sekcje konfiguracji">
    <a href="#site-settings"><span aria-hidden="true">⌂</span><span><strong>Witryna</strong><small>Nazwa, adres i
                layout</small></span></a>
    <a href="#seo-settings"><span aria-hidden="true">◎</span><span><strong>SEO</strong><small>Metadane i
                języki</small></span></a>
    <a href="#media-settings"><span aria-hidden="true">▧</span><span><strong>Multimedia</strong><small>Upload i
                obrazy</small></span></a>
    <a href="#text-files"><span aria-hidden="true">≡</span><span><strong>Pliki tekstowe</strong><small>LLM i
                security.txt</small></span></a>
</nav>
