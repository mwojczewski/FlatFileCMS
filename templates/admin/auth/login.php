...
<form class="auth-form" method="post" action="/admin/login">
    ...
    <label>
        <span>Email</span>
        <input type="email" name="email" required autocomplete="username" placeholder="nazwa@example.com">
    </label>
    <label>
        <span>Hasło</span>
        <input type="password" name="password" required autocomplete="current-password" placeholder="Wprowadź hasło">
    </label>
    <div class="auth-form-meta">
        <a href="/admin/password/forgot">Nie pamiętasz hasła?</a>
    </div>
