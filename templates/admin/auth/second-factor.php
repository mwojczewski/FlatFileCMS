<div class="second-factor-intro">
    ...
    <p>Potwierdź logowanie zarejestrowanym passkey, Face ID/Windows Hello albo kluczem bezpieczeństwa.</p>
</div>
<button class="auth-primary-action" type="button" data-webauthn-login>Użyj uwierzytelnienia</button>
<p class="auth-help">
    Postępuj zgodnie z komunikatem przeglądarki. Możesz użyć passkey, Face ID, Windows Hello lub klucza sprzętowego.
</p>
