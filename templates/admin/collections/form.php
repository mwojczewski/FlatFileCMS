...
<div class="form-page-header">
    <div>
        <p class="eyebrow">Ustawienia kolekcji</p>
        <h2><?= $escape($title[$languages->default()] ?? $identity->value()) ?></h2>
        <p class="lead">Routing, paginacja i sposób prezentowania elementów kolekcji.</p>
    </div>
    <div class="form-page-actions"><a class="button secondary" href="/admin/pages">Wróć do stron</a><a
            class="button secondary" href="/admin/media?path=<?= rawurlencode($identity->value()) ?>">Multimedia</a>
    </div>
</div>
<form class="stack crud-form editor-form" method="post" action="/admin/collections/update">
    <input type="hidden" name="_csrf" value="<?= $escape($csrfToken) ?>"><input type="hidden" name="identity"
        ...
        value="<?= $escape($editable->revision()->value()) ?>">
    <section class="form-section">
        <div class="section-heading">
            <div>
                <p class="eyebrow">Podstawowe</p>
                <h2>Ustawienia kolekcji</h2>
            </div>
    ...
    <section class="form-section">
        <div class="section-heading">
            <div>
                ...
                <h2>Tytuły i adresy</h2>
            </div>
            <p>Język domyślny jest wymagany. Puste tłumaczenie użyje jego tytułu i sluga.</p>
        </div>
    ...
    <section class="form-section">
        <div class="section-heading">
            <div>
                ...
                <h2>Sortowanie, paginacja i filtry</h2>
            </div>
