...
return static function (Router $router, ?Container $container = null): void {
    ...
    if ($container !== null) {
        ...
        $router->post('/admin/pages/reorder', static fn(Request $request): Response => $pages()->reorder($request), 'admin.pages.reorder');
        ...
        $router->post('/admin/pages/builder/render-preview', static fn(Request $request): Response => $builder()->renderPreview($request), 'admin.builder.render-preview');
