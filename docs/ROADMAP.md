...
## Stage 14 — redesigned administration workspace (complete)

- lightweight, responsive administration shell with compact and expanded sidebar modes;
- administrator profiles with names, UUIDv7 identifiers and protected superadmin visibility;
- hierarchical page and collection workspace with drag-and-drop nesting, ordering and file modification metadata;
- navigation editor with immediate persistence and compact contextual actions;
- visual, WordPress-inspired block editor with scaled server-rendered previews and an internal inspector;
- live block preview, content/appearance/visibility panels, automatic ordering persistence and keyboard/touch move controls;
- bounded, internally scrolling Markdown and inspector workspaces for long documents;
- generated favicon, Apple Touch Icon and PWA icon sets with validated raster source images;
- Web App Manifest creator covering identity, launch scope, display mode and application colors;
- modular administration stylesheets and separately loaded CSS for block previews, with no PHP-embedded preview styles;
- authentication failure audit events and configuration for public SEO/support files.

## Next candidates

- end-to-end browser tests for page-tree and block-editor drag interactions;
- optional draft/review workflow and scheduled publication;
- reusable block patterns and shared/global blocks;
- accessibility audit against WCAG 2.2 AA and touch-device usability testing;
- import/export package for configuration, navigation and selected content trees.
